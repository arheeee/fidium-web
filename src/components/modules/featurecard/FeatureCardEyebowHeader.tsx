...
const FeatureCardEyebowHeader = ({
  ...
  return (
    ...
    {
      cardFeature.featureCardEyebrowType === "eyebrowText" ? <div className="text-center font-bold md:text-start uppercase text-green-600 text-xl">{cardFeature.featureCardEyebrowText}</div> : <Image src={process.env.NEXT_PUBLIC_CRAFT_CMS_BASE_PATH + cardFeature.featureCardEyebrowImage[0]?.url} width={100} height={100} alt="card image" />
    }
